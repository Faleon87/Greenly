...
var calendar_1 = require("../entities/calendar"); // Asegúrate de importar tu entidad Calendar
var CalendarService = function () {
    ...
    var CalendarService = _classThis = /** @class */ (function () {
        function CalendarService_1(calendarRepository) {
            this.calendarRepository = calendarRepository;
        }
        CalendarService_1.prototype.insertarCalendar = function (calendarInsertDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    try {
                        ...
                        return [2 /*return*/, this.calendarRepository.save(calendar)];
                    }
                    catch (error) {
                        console.log(error);
                        throw error;
        ...
        CalendarService_1.prototype.obtenerPorFechaYUsuario = function (fecha, idUser) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    try {
                        ...
                        return [2 /*return*/, this.calendarRepository.createQueryBuilder('calendar')
                                ...
                                .where('calendar.fecha = :fecha', { fecha: fecha })
                                .andWhere('calendar.idUsuario = :idUser', { idUser: idUser })
                                .getMany()];
                    }
                    catch (error) {
                        console.error(error);
