...
var PlagasController = function () {
    var _classDecorators = [(0, common_1.Controller)('plagas')];
    ...
    var PlagasController = _classThis = /** @class */ (function () {
        function PlagasController_1(plagasService, plagasDto) {
            this.plagasService = (__runInitializers(this, _instanceExtraInitializers), plagasService);
            this.plagasDto = plagasDto;
        }
        PlagasController_1.prototype.getAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                var plagas;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.plagasService.findAll()];
                        case 1:
                            plagas = _a.sent();
                            return [2 /*return*/, plagas.map(function (plaga) { return ({
        ...
        PlagasController_1.prototype.getById = function (idPlanta) {
            return __awaiter(this, void 0, void 0, function () {
                var detallePlaga;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.plagasService.findById(idPlanta)];
                        case 1:
                            detallePlaga = _a.sent();
                            return [2 /*return*/, {
        ...
        return PlagasController_1;
    }());
    __setFunctionName(_classThis, "PlagasController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _getAll_decorators = [(0, common_1.Get)('cards')];
        _getById_decorators = [(0, common_1.Get)(':idPlaga')];
        ...
        PlagasController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PlagasController = _classThis;
}();
