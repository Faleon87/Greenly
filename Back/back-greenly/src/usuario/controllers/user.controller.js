...
var UserController = function () {
    ...
    var UserController = _classThis = /** @class */ (function () {
        ...
        UserController_1.prototype.login = function (username, password) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.login(username, password)];
                });
            });
        };
        UserController_1.prototype.register = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this.userService.register(createUserDto)];
                });
            });
        };
        UserController_1.prototype.getProfile = function (idUser) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.getProfile(idUser)];
                });
            });
        };
        UserController_1.prototype.update = function (idUser, updatedData) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.update(idUser, updatedData)];
                });
            });
        };
